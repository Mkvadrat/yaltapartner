...
class ControllerUserUser extends Controller {  
	private $error = array();
  	...
  	public function update() {
        ...
        if (!empty($_FILES['image']['tmp_name'])) {
            ...
            $file = '/image/agent/'.md5($_FILES['image']['tmp_name']).'.'.$type;
            $path =  $dir.$file;
            $uploadfile = $dir.'/image/agent/'.md5($_FILES['image']['tmp_name']).'.'.$type;
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_user_user->editUser($this->request->get['user_id'], $this->request->post,$file);
	...
	private function getForm() {
        ...
        if (isset($this->request->post['skype'])) {
            ...
            $this->data['skype'] = $user_info['skype'];
        } else {
            $this->data['skype'] = '';
        }
        ...
        if (isset($this->request->post['phone_1'])) {
            ...
            $this->data['phone_1'] = $user_info['phone_1'];
        } else {
            $this->data['phone_1'] = '';
        }
        if (isset($this->request->post['phone_2'])) {
            ...
            $this->data['phone_2'] = $user_info['phone_2'];
        } else {
            $this->data['phone_2'] = '';
        }
