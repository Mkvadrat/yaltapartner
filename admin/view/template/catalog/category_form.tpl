...
<div id="content">
  ...
  <div class="box">
    <div class="heading">
      <h1><img src="view/image/category.png" alt="" /> <?php echo $heading_title_category; ?><span class="catname"></span></h1>
        ...
        <div id="tab-data">
          <table class="form">
            <tr>
              ...
              <td width="150"><select name="parent_id">
