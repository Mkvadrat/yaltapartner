$(document).ready(function(){
	...
	if(buttonExists > 0){
		...
		$(".buttons .button").each(function(){
			...
			}else if(getCancelButton[0] && !getCancelButton[2]){
				// alert("Cancel, mi Lord!");
