...
function success(g, b) {
    ...
    if (g.result_html && hash) {
        $('.product-list').html(g.result_html);
        //afterload();

        $(".pagination").html(g.pagination);
    }
    if (g.result_html =='') {
        $('.product-list').html('Дома отсутствуют');
        //afterload();
    }
...
function doFilter(b) {
    ...
    price = $('#pricesort').attr('data-sort');
    valuta = $('#valutesort').attr('data-valute');
    a +='&'+price+'&valute='+valuta;
...
$(document).ready(function () {
    ...
    $(".pagination .links a").live("click", (function (e) {
        ...
        doFilter(false);
        $('html, body').animate({ scrollTop: $('.product-list').offset().top }, 'slow');
        return false;
    }));
...
// deserialize
    ...
    if (hash) {
        var valuta = $( "input:radio[name=valute]:checked" ).val();
