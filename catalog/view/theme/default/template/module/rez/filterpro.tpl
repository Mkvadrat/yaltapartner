...
<div class='attribute_box'>
    ...
    <table style="width:100%">
        <tr>
            ...
            <td><span>от</span><input class="price_limit" type="text" name="min_price" value="-1" id="min_price" placeholder="руб."/></td>
</tr>
     <tr>       <td><span>до</span><input class="price_limit" type="text" name="max_price" value="-1" id="max_price" placeholder="руб."/></td>
