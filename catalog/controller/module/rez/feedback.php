...
class ControllerModuleFeedback extends Controller {
	...
	*/
	private function validate($settings) {
        ...
        $required_fields['form_id'] = $this->request->post['form_id'];
        $required_fields['name'] = $this->request->post['wsf_name'];
        $required_fields['phone'] = $this->request->post['wsf_phone'];
        $required_fields['text'] = $this->request->post['wsf_enquiry'];
